...
public class Enchants {
    ...
    public static void load () {
        if (EnchantConfigHandler.isEnabled("AdrenalineBoost", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", AdrenalineBoost.getName());
        }
        if (EnchantConfigHandler.isEnabled("AuraDark", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", AuraDark.getName());
        }
        if (EnchantConfigHandler.isEnabled("AuraDeadly", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", AuraDeadly.getName());
        }
        if (EnchantConfigHandler.isEnabled("AuraFiery", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", AuraFiery.getName());
        }
        if (EnchantConfigHandler.isEnabled("AuraThick", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", AuraThick.getName());
        }
        if (EnchantConfigHandler.isEnabled("AuraToxic", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", AuraToxic.getName());
        }
        if (EnchantConfigHandler.isEnabled("Regen", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", ArmorRegen.getName());
        }
        if (EnchantConfigHandler.isEnabled("ArrowExplosive", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", ArrowExplosive.getName());
        }
        if (EnchantConfigHandler.isEnabled("Zeus", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Zeus.getName());
        }
        if (EnchantConfigHandler.isEnabled("ArrowSeeking", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", ArrowSeeking.getName());
        }
        if (EnchantConfigHandler.isEnabled("BattleHealing", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", BattleHealing.getName());
        }
        if (EnchantConfigHandler.isEnabled("Bound", "other")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Bound.getName());
        }
        if (EnchantConfigHandler.isEnabled("DivineIntervention", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", DivineIntervention.getName());
        }
        if (EnchantConfigHandler.isEnabled("Examine", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Examine.getName());
        }
        if (EnchantConfigHandler.isEnabled("FlameTouch", "other")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", FlameTouch.getName());
        }
        if (EnchantConfigHandler.isEnabled("Fly" , "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Fly.getName());
        }
        if (EnchantConfigHandler.isEnabled("JumpBoost", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", JumpBoost.getName());
        }
        if (EnchantConfigHandler.isEnabled("LifeSteal", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", LifeSteal.getName());
        }
        if (EnchantConfigHandler.isEnabled("LeadFooted", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", LeadFooted.getName());
        }
        if (EnchantConfigHandler.isEnabled("Poison", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Poison.getName());
        }
        if (EnchantConfigHandler.isEnabled("Piercing", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Piercing.getName());
        }
        if (EnchantConfigHandler.isEnabled("Repair", "other")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Repair.getName());
        }
        if (EnchantConfigHandler.isEnabled("Shroud" , "armor")){
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Shroud.getName());
        }
        if (EnchantConfigHandler.isEnabled("SoulTear", "weapon")){
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", SoulTear.getName());
        }
        if (EnchantConfigHandler.isEnabled("SCurse", "weapon")){
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", SCurse.getName());
        }
        if (EnchantConfigHandler.isEnabled("Stealth", "armor")){
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Stealth.getName());
        }
        if (EnchantConfigHandler.isEnabled("Swiftness", "armor")){
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Swiftness.getName());
        }
        if (EnchantConfigHandler.isEnabled("Vampirism", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Vampirism.getName());
        }
        if (EnchantConfigHandler.isEnabled("Vitality", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Vitality.getName());
        }
        if (EnchantConfigHandler.isEnabled("Vorpal", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Vorpal.getName());
        }
        if (EnchantConfigHandler.isEnabled("WitherProtection", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", WitherProtection.getName());
        }
        if (EnchantConfigHandler.isEnabled("SpeedMine", "tool")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", SpeedMine.getName());
        }
        if (EnchantConfigHandler.isEnabled("VoidTouch", "tool")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", VoidTouch.getName());
        }
        if (EnchantConfigHandler.isEnabled("EnchLeech", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", EnchLeech.getName());
        }
        if (EnchantConfigHandler.isEnabled("PipeMine", "tool")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", PipeMine.getName());
        }
        if (EnchantConfigHandler.isEnabled("FeatherFall", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", FeatherFall.getName());
        }
        if (EnchantConfigHandler.isEnabled("MeteorFall", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", MeteorFall.getName());
        }
        if (EnchantConfigHandler.isEnabled("OverCharge", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Overcharge.getName());
        }
        if (EnchantConfigHandler.isEnabled("ExplosiveDischarge", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", ExplosiveDischarge.getName());
        }
        if (EnchantConfigHandler.isEnabled("GaiaAura", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", GaiaAura.getName());
        }
        if (EnchantConfigHandler.isEnabled("FlashStep", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", FlashStep.getName());
        }
        if (EnchantConfigHandler.isEnabled("FlamingArrow", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", FlamingArrow.getName());
        }
        if (EnchantConfigHandler.isEnabled("HealingAura", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", HealingAura.getName());
        }
        if (EnchantConfigHandler.isEnabled("Gluttony", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", Gluttony.getName());
        }
        if (EnchantConfigHandler.isEnabled("RepulsiveAura", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", RepulsiveAura.getName());
        }
        if (EnchantConfigHandler.isEnabled("AuraMagnetic", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", AuraMagnetic.getName());
        }
        if (EnchantConfigHandler.isEnabled("IcyAura", "armor")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", IcyAura.getName());
        }
        if (EnchantConfigHandler.isEnabled("LightningArrow", "weapon")) {
            ...
            Enchs++;
            if (Configurations.blackListFromEPlus)FMLInterModComms.sendMessage("eplus", "blacklist-enchantment", LightningArrow.getName());
        }
