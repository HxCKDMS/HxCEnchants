...
import HxCKDMS.HxCEnchants.enchantment.*;
...
//    public static Enchantment Stealth;
    ...
    public void preinit(FMLPreInitializationEvent event)
    {
        ...
        Class.forName( "HxCKDMS.HxCCore.HxCCore" );
            ...
            if (HxCKDMS.HxCEnchants.Config.DebugMode || DevMode){
                FMLCommonHandler.instance().getFMLLogger().log(Level.ERROR, "[HxCEnchants] HxCCore not found! Please Grab it from our site!");
            }else{
...
*/
        ...
        if(HxCKDMS.HxCEnchants.Config.enchFlyEnable){
