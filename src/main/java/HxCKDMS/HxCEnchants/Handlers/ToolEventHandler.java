        ...
        if (ent instanceof EntityPlayerMP && hurtent instanceof EntityLiving && ((EntityPlayerMP) ent).getHeldItem() != null){
            ...
            if (Config.enchSCurseEnable) {
                ...
                if (SCurseLevel > 0) {
                    ...
                    Attacker.addPotionEffect(new PotionEffect(Potion.digSlowdown.getId(), 120, Config.enchSCurseVals[4] * SCurseLevel, true));
                    Attacker.addPotionEffect(new PotionEffect(Potion.moveSlowdown.getId(), 120, Config.enchSCurseVals[4] * SCurseLevel, true));
                    Attacker.addPotionEffect(new PotionEffect(Potion.weakness.getId(), 120 * SCurseLevel, SCurseLevel, true));
                }
            }
        }
    }
