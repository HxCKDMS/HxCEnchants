...
public class PacketInfuserSync implements IMessage {
    private int x = 0, y = 0, z = 0, xpti = 0;
    private String player;

    public PacketInfuserSync() {}

    public PacketInfuserSync(int x, int y, int z, int xpti, String player) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.xpti = xpti;
    ...
    public static class handler implements IMessageHandler<PacketInfuserSync, IMessage> {
        @Override
        public IMessage onMessage(PacketInfuserSync message, MessageContext ctx) {
