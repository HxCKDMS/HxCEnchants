...
public class Config
{
    ...
    public static boolean EDT, PAuraDeadly, PAuraFiery, PAuraThick, PAuraDark, PAuraToxic,  enableChargesSystem;
    ...
    public Config(Configuration config)
    {
        ...
        config.setCategoryComment("C Armor Enchant Values", "ID, Max Level, Weight, Cost, Charge Drain Rate, Special");
        config.setCategoryComment("E Arrow Enchant Values", "ID, Max Level, Weight, Cost, Charge Drain Rate, Special");
        config.setCategoryComment("G Tool/Weapon Enchant Values", "ID, Max Level, Weight, Cost, Charge Drain Rate, Special");

        /** Features **/
        EDT = config.getBoolean("ExplosionDestroysTerrain", "A Features", false, "");
        PiercingPercent = config.getFloat("PiercingPercent", "A Features", 0.15f, 0.01f, 10000.0f, "set this value as high as you want");
        enableChargesSystem = config.getBoolean("EnableChargesSystem", "A Features", true, "");
        ...
        enchAdrenalineBoostVals = config.get("C Armor Enchant Values", "AdrenalineBoostVals", new int[]{400, 4, 10, 30, 20}).getIntList();
        enchBattleHealingVals = config.get("C Armor Enchant Values", "BattleHealingVals", new int[]{402, 4, 3, 40, 20}).getIntList();
        enchFlyVals = config.get("C Armor Enchant Values", "FlyVals", new int[]{403, 1, 1, 55, 20}).getIntList();
        enchJumpBoostVals = config.get("C Armor Enchant Values", "JumpBoostVals", new int[]{404, 4, 10, 20, 2}).getIntList();
        enchRepairVals = config.get("C Armor Enchant Values", "RepairVals", new int[]{405, 4, 1, 15, 35, 20, 6}).getIntList();
        enchRegenVals = config.get("C Armor Enchant Values", "RegenVals", new int[]{406, 4, 1, 15, 50, 20, 6}).getIntList();
        enchSwiftnessVals = config.get("C Armor Enchant Values", "SwiftnessVals", new int[]{407, 4, 10, 20, 20}).getIntList();
        enchVitalityVals = config.get("C Armor Enchant Values", "VitalityVals", new int[]{408, 4, 4, 30, 20}).getIntList();
        enchWitherProtectionVals = config.get("C Armor Enchant Values", "WitherProtectionVals", new int[]{409, 4, 8, 40, 20}).getIntList();
        enchBoundVals = config.get("C Armor Enchant Values", "BoundVals", new int[]{410, 3, 5, 45, 20}).getIntList();
        enchLeadFootedVals = config.get("C Armor Enchant Values", "LeadFootedVals", new int[]{411, 1, 10, 20, 20}).getIntList();
        enchShroudVals = config.get("C Armor Enchant Values", "ShroudVals", new int[]{412, 1, 2, 45, 20}).getIntList();
        enchStealthVals = config.get("C Armor Enchant Values", "StealthVals", new int[]{413, 2, 6, 40, 20}).getIntList();
        enchAuraDeadlyVals = config.get("C Armor Enchant Values", "DeadlyAuraVals", new int[]{414, 10, 1, 50, 20}).getIntList();
        enchAuraFieryVals = config.get("C Armor Enchant Values", "FieryAuraVals", new int[]{415, 10, 5, 30, 20}).getIntList();
        enchAuraThickVals = config.get("C Armor Enchant Values", "ThickAuraVals", new int[]{416, 10, 10, 20, 20}).getIntList();
        enchAuraToxicVals = config.get("C Armor Enchant Values", "ToxicAuraVals", new int[]{417, 10, 5, 35, 20}).getIntList();
        enchAuraDarkVals = config.get("C Armor Enchant Values", "DarkAuraVals", new int[]{418, 10, 15, 20, 20}).getIntList();
        enchDivineInterventionVals = config.get("C Armor Enchant Values", "DivineInterventionVals", new int[]{419, 5, 1, 45, 20}).getIntList();
        ...
        enchArrowExplosiveVals = config.get("E Arrow Enchant Values", "ArrowExplosiveVals", new int[]{421, 4, 2, 40, 20}).getIntList();
        enchArrowLightningVals = config.get("E Arrow Enchant Values", "ArrowLightningVals", new int[]{422, 1, 5, 30, 20}).getIntList();
        enchArrowSeekingVals = config.get("E Arrow Enchant Values", "ArrowSeekingVals", new int[]{423, 4, 1, 45, 20}).getIntList();
        enchArrowPiercingVals = config.get("E Arrow Enchant Values", "ArrowPiercingVals", new int[]{424, 5, 1, 40, 20}).getIntList();
        ...
        enchFlameTouchVals = config.get("G Tool/Weapon Enchant Values", "FlameTouchVals", new int[]{431, 4, 2, 30, 20}).getIntList();
        enchLifeStealVals = config.get("G Tool/Weapon Enchant Values", "LifeStealVals", new int[]{432, 5, 7, 35, 20}).getIntList();
        enchPoisonVals = config.get("G Tool/Weapon Enchant Values", "PoisonVals", new int[]{433, 4, 10, 25, 20}).getIntList();
        enchVampirismVals = config.get("G Tool/Weapon Enchant Values", "VampirismVals", new int[]{434, 5, 3, 45, 20}).getIntList();
        enchExamineVals = config.get("G Tool/Weapon Enchant Values", "ExamineVals", new int[]{435, 10, 1, 55, 20}).getIntList();
        enchPiercingVals = config.get("G Tool/Weapon Enchant Values", "PiercingVals", new int[]{436, 10, 1, 50, 20}).getIntList();
        enchVenomVals = config.get("G Tool/Weapon Enchant Values", "VenomVals", new int[]{437, 4, 1, 20, 25, 20}).getIntList();
        enchVorpalVals = config.get("G Tool/Weapon Enchant Values", "VorpalVals", new int[]{438, 10, 1, 55, 20, 1}).getIntList();
        enchSCurseVals = config.get("G Tool/Weapon Enchant Values", "SCurseVals", new int[]{439, 10, 1, 55, 20, 3}).getIntList();
